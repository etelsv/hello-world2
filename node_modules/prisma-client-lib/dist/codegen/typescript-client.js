...
var TypescriptGenerator = /** @class */ (function (_super) {
    ...
    function TypescriptGenerator(_a) {
        ...
        var _this = _super.call(this, { schema: schema }) || this;
    ...
    TypescriptGenerator.prototype.renderInterfaceOrObject = function (type, node, subscription) {
        ...
        var fieldDefinition = Object.keys(fields)
            ...
            return node ? !graphql_1.isObjectType(deepType) : true;
        })
            .map(function (f) {
            var field = fields[f];
    ...
    TypescriptGenerator.prototype.renderFieldType = function (_a) {
        var field = _a.field, node = _a.node, input = _a.input, partial = _a.partial, renderFunction = _a.renderFunction, _b = _a.isMutation, isMutation = _b === void 0 ? false : _b, _c = _a.isSubscription, isSubscription = _c === void 0 ? false : _c, _d = _a.operation, operation = _d === void 0 ? false : _d;
        var type = field.type;
        var deepType = this.getDeepType(type);
        ...
        return "<T " + this.genericsDelimiter + " " + typeString + ">(" + (field.args && field.args.length > 0
            ? this.renderArgs(field, isMutation, false)
            : '') + ") => T";
    };
